...
uci_hard_dir <- "/home/jt/Dropbox/R/Coursera 3 Getting and Cleaning Data/data/UCI HAR Dataset"
...
# 2. Extract from each measurement only the measurements on the mean and standard deviation.
